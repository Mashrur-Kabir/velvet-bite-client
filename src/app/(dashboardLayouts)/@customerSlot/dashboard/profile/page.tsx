...
export default async function ProfilePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-16 pb-20 px-6">
      ...
      {/* 2. Main content: Centered Grid for better visual balance */}
      <main className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="space-y-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-cream/10 pb-6">
            ...
            {/* Highlighted "View All Reviews" Link */}
            <Link
            ...
            {reviewableOrders.length > 0 ? (
              reviewableOrders.map((order, index) => (
                ...
                >
                  ...
                  <Link
                    href={`/dashboard/profile/create-review?mealId=${order.items[0]?.meal?.id}`} // Change .mealId to .meal?.id
